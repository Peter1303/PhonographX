...
import com.peter1303.phonograph.adapter.song.SongAdapter;
...
public class GenresDetailActivity extends AbsSlidingMusicPanelActivity implements CabHolder, LoaderManager.LoaderCallbacks<List<Song>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genres = getIntent().getExtras().getParcelable(EXTRA_GENRE);
    ...
    private void setUpToolBar() {
        ...
        getSupportActionBar().setTitle(genres.name);
    ...
    public Loader<List<Song>> onCreateLoader(int id, Bundle args) {
        return new GenresDetailActivity.AsyncGenreSongLoader(this, genres);
    }
    ...
    private static class AsyncGenreSongLoader extends WrappedAsyncTaskLoader<List<Song>> {
        ...
        public AsyncGenreSongLoader(Context context, Genres genres) {
            super(context);
            this.genres = genres;
        }
        ...
        public List<Song> loadInBackground() {
            return GenresLoader.getSongs(getContext(), genres.id);
        }
    }
}
