...
import com.peter1303.phonograph.ui.activities.bugreport.BugReportActivity;
...
public class AboutActivity extends AbsBaseActivity implements View.OnClickListener {
    ...
    private static String GITHUB = "https://github.com/Peter1303/PhonographX";
    ...
    private static String getCurrentVersionName(@NonNull final Context context) {
        try {
            return context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionName + (new PurchaseUtil(context).isProVersion() ? " Pro" : "");
